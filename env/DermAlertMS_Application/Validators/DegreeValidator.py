...
class DegreeValidator(Form):
    description = StringField('degree description', validators=[
        validators.DataRequired(message="Debe ingresar información para el grado académico"),
