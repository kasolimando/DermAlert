...
class SpecialityValidator(Form):
    description = StringField('Speciality description', validators=[
        validators.DataRequired(message="Debe ingresar información para la especialidad"),
