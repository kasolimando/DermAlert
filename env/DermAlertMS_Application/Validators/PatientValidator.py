...
class PatientValidator(Form):
    ...
    birthdate = StringField('phone', validators=[
       validators.DataRequired(message="Debe ingresar su fecha de nacimiento"),
        validators.Date(),  
        validators.PastDate(message="La fecha debe ser en el pasado"),
        validators.Before(date.today(), message="La fecha no puede ser posterior a hoy")
    ])
